...
# symlink for nvim
[ -d ~/.config/nvim ] && mv -r ~/.config/nvim ~/old_config
ln -s ~/dotfiles/nvim ~/.config/nvim

# symlink for superfile
[ -d ~/.config/superfile ] && mv -r ~/.config/superfile ~/old_config
...
[ -d ~/.config/ulauncher ] && mv -r ~/.config/ulauncher ~/old_files
ln -s ~/dotfiles/ulauncher ~/.config/ulauncher

# symlink for yazi
[ -d ~/.config/yazi ] && mv -r ~/.config/yazi ~/old_config
